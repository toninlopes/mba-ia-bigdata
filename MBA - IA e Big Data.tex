...
% ---
\include{Cursos/02 - Ciência de Dados, Aprendizado de Máquina e Mineração de Dados/Naive Bayes.tex}

\include{Cursos/02 - Ciência de Dados, Aprendizado de Máquina e Mineração de Dados/Árvore de Decisão.tex}

\include{Cursos/02 - Ciência de Dados, Aprendizado de Máquina e Mineração de Dados/Avaliação de Classificadores.tex}

\include{Cursos/02 - Ciência de Dados, Aprendizado de Máquina e Mineração de Dados/Random Forest.tex}

\include{Cursos/02 - Ciência de Dados, Aprendizado de Máquina e Mineração de Dados/Support Vector Machine.tex}

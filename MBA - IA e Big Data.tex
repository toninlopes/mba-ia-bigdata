...
% ---
\include{Cursos/02 - Ciência de Dados, Aprendizado de Máquina e Mineração de Dados/NaiveBayes.tex}
...
\include{Cursos/02 - Ciência de Dados, Aprendizado de Máquina e Mineração de Dados/KNN.tex}

\include{Cursos/02 - Ciência de Dados, Aprendizado de Máquina e Mineração de Dados/RegressaoLinear.tex}

\include{Cursos/02 - Ciência de Dados, Aprendizado de Máquina e Mineração de Dados/MineracaoDeDados.tex}

\include{Cursos/02 - Ciência de Dados, Aprendizado de Máquina e Mineração de Dados/AgrupamentoHierarquico.tex}

\include{Cursos/02 - Ciência de Dados, Aprendizado de Máquina e Mineração de Dados/AgrupamentoParticional.tex}

\include{Cursos/02 - Ciência de Dados, Aprendizado de Máquina e Mineração de Dados/ValidacaoDeAgrupamento.tex}

\include{Cursos/02 - Ciência de Dados, Aprendizado de Máquina e Mineração de Dados/RegrasDeAssociacao.tex}

\include{Cursos/02 - Ciência de Dados, Aprendizado de Máquina e Mineração de Dados/MineracaoDeDadosNaoEstruturados.tex}
% ---


\part[Curso 3 - Introdução ao Gerenciamento de Dados em Larga Escala e Big Data]{Curso 3 - Introdução ao Gerenciamento de Dados em Larga Escala e Big Data}

\include{Cursos/03 - Gerenciamento de Dados em Larga Escala/Introducao.tex}


\part[Curso 4 - Estatística na Ciência da Computação Experimental]{Curso 4 - Estatística na Ciência da Computação Experimental}

\include{Cursos/04 - Estatistica na Ciencia da Computacao Experimental e R/Introducao.tex}

\include{Cursos/04 - Estatistica na Ciencia da Computacao Experimental e R/DistribuicaoProbabilistica.tex}

\include{Cursos/04 - Estatistica na Ciencia da Computacao Experimental e R/AnaliseDescritiva.tex}

\include{Cursos/04 - Estatistica na Ciencia da Computacao Experimental e R/InferenciaEstatistica.tex}

\include{Cursos/04 - Estatistica na Ciencia da Computacao Experimental e R/RegressaoLinear.tex}

\include{Cursos/04 - Estatistica na Ciencia da Computacao Experimental e R/RegressaoLogistica.tex}

\include{Cursos/04 - Estatistica na Ciencia da Computacao Experimental e R/InferenciaBayesiana.tex}



\part[Curso 5 - Redes Neurais e Deep Learning]{Curso 5 - Redes Neurais e Deep Learning}

\include{Cursos/05 - Redes Neurais e Deep Learning/Introducao.tex}

\include{Cursos/05 - Redes Neurais e Deep Learning/ModeloConexionista.tex}

\include{Cursos/05 - Redes Neurais e Deep Learning/Perceptron.tex}

\include{Cursos/05 - Redes Neurais e Deep Learning/PerceptronMultiCamadas.tex}

\include{Cursos/05 - Redes Neurais e Deep Learning/AtivacaoRegularizacao.tex}

\include{Cursos/05 - Redes Neurais e Deep Learning/RedesNeuraisConvolucionaisIntroducao.tex}

\include{Cursos/05 - Redes Neurais e Deep Learning/RedesNeuraisConvolucionaisOperacoes.tex}

\include{Cursos/05 - Redes Neurais e Deep Learning/RedesNeuraisConvolucionaisArquiteturas.tex}

\include{Cursos/05 - Redes Neurais e Deep Learning/RedesNeuraisConvolucionaisTransferLearning.tex}

\include{Cursos/05 - Redes Neurais e Deep Learning/RedesNeuraisConvolucionaisGAN.tex}

\include{Cursos/05 - Redes Neurais e Deep Learning/RedesNeuraisRecorrentesIntroducao.tex}

\include{Cursos/05 - Redes Neurais e Deep Learning/RedesNeuraisConvolucionaisTemporais.tex}

\include{Cursos/05 - Redes Neurais e Deep Learning/Transformers.tex}

\include{Cursos/05 - Redes Neurais e Deep Learning/AprendizadoPorReforco.tex}
